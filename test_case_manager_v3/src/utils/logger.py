...
class ColoredConsoleHandler(logging.StreamHandler):
    ...
    This handler adds ANSI color codes to log messages based on their level,
    making it easier to distinguish between different severity levels in the console.
    """
    
    # Color codes for different log levels using a type hint
    COLORS: Dict[int, str] = {
    ...
    def format(self, record: logging.LogRecord) -> str:
        ...
        Returns:
            Formatted log message with color codes if terminal supports it
        """
...
def setup_logging(
    ...
    if log_to_file:
        ...
        try:
            ...
            # Use console output as fallback for this specific error
            print(f"Warning: Could not setup file logging: {e}")
            # Still continue without file logging
...
def get_logger(name: Optional[str] = None) -> logging.Logger:
    ...
    if name is None:
        ...
        try:
            ...
            # Properly clean up the frame reference to prevent reference cycles
            del frame
...
class LoggerMixin:
    ...
    This mixin provides a logger property that returns a logger instance
    with the name of the class that includes this mixin.
